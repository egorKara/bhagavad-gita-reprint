...
> 📖 **Подробные инструкции по настройке .NET:** [DOTNET_SETUP_INSTRUCTIONS.md](DOTNET_SETUP_INSTRUCTIONS.md)
...
## 🚨 ВАЖНО: РЕОРГАНИЗАЦИЯ СТРУКТУРЫ ПРОЕКТА

**🎯 ПРИОРИТЕТ: КРИТИЧЕСКИЙ (НАИВЫСШИЙ)**

Проект готовится к реорганизации структуры по международным стандартам 2025 года:
...
- **Долгосрочные меры по предотвращению хаоса**
- **Автоматический контроль структуры проекта**

### 📋 Планы реорганизации:
- **[Детальный план реорганизации](PROJECT_REORGANIZATION_PLAN_2025.md)** - Полный план на 21 день
- **[Краткий TODO список](PROJECT_REORGANIZATION_TODOS.md)** - Быстрый доступ к задачам

### 🛡️ Долгосрочные меры по сохранению стандартов:
- **Автоматический контроль структуры** - Pre-commit хуки, GitHub Actions, cron задачи
- **Система предотвращения хаоса** - Шаблоны, правила, автоматические проверки
- **Стандарты качества кода** - ESLint, Prettier, Husky
- **Документация и обучение** - Руководства, чек-листы, обучающие материалы
...
- **[📖 Подробное описание правила](CRITICAL_FILE_READING_RULE.md)**
...
- **Принцип:** Один инструмент для каждой задачи
...
- **Принцип:** Не принимать решения без участия пользователя
...
**Автономный AI-агент для поддержания сервера в отличном состоянии 24/7:**

- **📊 Мониторинг:** API, сервисы, ресурсы системы каждые 15 минут  
- **🤖 AI-анализ:** Логи + YandexGPT симуляция каждые 30 минут
- **📱 Telegram:** Критические алерты + интерактивные команды
- **📈 Метрики:** Системные, приложения, бизнес (каждые 5 минут)
