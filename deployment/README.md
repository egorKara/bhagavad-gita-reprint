...
1. 📋 Запустите диагностику: `bash deployment/server-monitor.sh`
2. 📝 Проверьте логи: `sudo journalctl -u gita-api -f`
3. 🧹 Выполните очистку: `sudo bash deployment/server-cleanup.sh`
4. 📧 Отправьте отчет администратору
