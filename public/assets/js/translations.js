...
const translations = {
    ru: {
        ...
        home: {
            ...
            description:
                'Точное воспроизведение легендарного издания с полным текстом, комментариями А.Ч. Бхактиведанты Свами Прабхупады и 44 оригинальными иллюстрациями',
            features: {
        ...
        about: {
            ...
            description:
                'Это точный репринт оригинального издания 1972 года, одобренный Bhaktivedanta Book Trust. Книга представляет собой полную версию с оригинальным текстом, который был сокращен при первом издании.',
            ...
            academicQuote:
                'Принося нам новое и живое толкование текста, уже известного многим, А.Ч. Бхактиведанта Свами Прабхупада увеличил наше понимание во много раз.',
            ...
            authenticityDesc:
                'Это издание представляет собой полную версию оригинальной рукописи, которая была сокращена при первом издании 1972 года. Теперь читатели получают доступ ко всем материалам, которые автор изначально планировал включить в книгу.',
            philosophicalAccuracy: 'Философская точность',
            philosophicalDesc:
                'Комментарии А.Ч. Бхактиведанты Свами Прабхупады основаны на аутентичной ведической традиции и передаются через парампару (ученическую преемственность). Это гарантирует точность философских интерпретаций.',
            historicalValue: 'Историческая ценность',
            historicalDesc:
                'Издание 1972 года стало культовым для западного мира, представив ведическую мудрость в доступной форме. Этот репринт сохраняет историческую значимость оригинального издания.',
        ...
        author: {
            ...
            description:
                'Основатель Международного общества сознания Кришны (ISKCON) и автор более 80 книг по ведической философии. Его перевод и комментарии к Бхагавад-Гите считаются наиболее аутентичными и полными, основанными на парампаре (ученической преемственности) от самого Господа Кришны.',
            ...
            childhoodDesc:
                'Абхай Чаран Де родился 1 сентября 1896 года в Калькутте, Индия, в семье торговца тканями. С детства он проявлял глубокий интерес к духовности и ведической культуре. В возрасте 22 лет он встретил своего духовного учителя Шрилу Бхактисиддханту Сарасвати Тхакура.',
            meetingGuru: 'Встреча с духовным учителем',
            meetingGuruDesc:
                'В 1922 году Шрила Бхактисиддханта Сарасвати Тхакура дал ему наставление: "Если у тебя есть деньги, напечатай книги". Это стало поворотным моментом в жизни Абхая Чарана, определившим его будущую миссию по распространению ведического знания.',
            renunciation: 'Принятие отречения',
            renunciationDesc:
                'В 1959 году Абхай Чаран принял отречение (санньясу) и получил имя А.Ч. Бхактиведанта Свами Прабхупада. С этого момента он полностью посвятил себя написанию книг и подготовке к миссии на Западе.',
            foreword: 'Предисловие к изданию 1972 года',
            missionWest: 'Миссия на Западе',
            journeyAmerica: 'Путешествие в Америку',
            journeyAmericaDesc:
                'В 1965 году, в возрасте 69 лет, Шрила Прабхупада отправился в Америку на грузовом корабле "Джаладута" с миссией распространить ведическое знание на Западе. У него было всего 40 рупий и несколько экземпляров его переводов.',
            foundingIskcon: 'Основание ISKCON',
            foundingIskconDesc:
                '13 июля 1966 года в Нью-Йорке Шрила Прабхупада официально основал Международное общество сознания Кришны (ISKCON). Это общество стало центром распространения ведической культуры и философии по всему миру.',
            publishing: 'Издательская деятельность',
            publishingDesc:
                'В 1972 году Шрила Прабхупада основал Bhaktivedanta Book Trust (BBT) для издания и распространения ведической литературы. Первой книгой, изданной BBT, стала "Бхагавад-Гита как она есть" от Macmillan Publishing.',
            preface: 'Предисловие с описанием миссии',
            literaryHeritage: 'Литературное наследие',
            mainWorks: 'Основные труды',
            mainWorksDesc:
                'За 12 лет активной деятельности на Западе Шрила Прабхупада написал, перевел и прокомментировал более 80 книг по ведической философии, включая:',
            ...
            mainPrinciplesDesc:
                'Философия Шрилы Прабхупады основана на Бхагавад-Гите и других ведических текстах. Ключевые принципы включают:',
            krishnaConsciousness: 'Сознание Кришны',
            krishnaConsciousnessDesc:
                'Высшая цель человеческой жизни — развитие любовных отношений с Верховной Личностью Бога',
            ...
            westernInfluenceDesc:
                'Благодаря трудам Шрилы Прабхупады ведическая философия стала доступна миллионам людей на Западе. Его книги переведены на более чем 80 языков и используются в университетах по всему миру.',
            legacy: 'Наследие',
            modernInfluence: 'Влияние на современный мир',
            modernInfluenceDesc:
                'Сегодня ISKCON насчитывает более 600 храмов, 100 сельскохозяйственных общин и 50 школ по всему миру. Книги Шрилы Прабхупады продолжают вдохновлять людей на духовный путь.',
            academicRecognition: 'Признание академическим сообществом',
            academicRecognitionDesc:
                'Работы Шрилы Прабхупады получили признание ведущих ученых и университетов, включая Гарвард, Оксфорд и Сорбонну. Его переводы считаются стандартом в изучении ведической литературы.',
            continuingMission: 'Продолжение миссии',
            continuingMissionDesc:
                'После ухода Шрилы Прабхупады в 1977 году его ученики продолжают его миссию по распространению ведического знания. Bhaktivedanta Book Trust продолжает издавать его книги на многих языках.',
            studyWorks: 'Изучите труды великого учителя',
            studyWorksDesc:
                'Погрузитесь в глубокую мудрость Бхагавад-Гиты с комментариями А.Ч. Бхактиведанты Свами Прабхупады'
        },
        ...
        contacts: {
            ru: {
                ...
                'Бхагавад-Гита как она есть — Оригинальное издание 1972 года':
                    'Бхагавад-Гита как она есть — Оригинальное издание 1972 года',
                ...
                // Форма заказа
                'Заполните форму ниже для оформления заказа. Все поля обязательны для заполнения.':
                    'Заполните форму ниже для оформления заказа. Все поля обязательны для заполнения.',
                'Имя *': 'Имя *',
                'Фамилия *': 'Фамилия *',
                'Email *': 'Email *',
                ...
                'Укажите любую дополнительную информацию по заказу':
                    'Укажите любую дополнительную информацию по заказу',
                'Я согласен с условиями заказа и политикой конфиденциальности *':
                    'Я согласен с условиями заказа и политикой конфиденциальности *',
                ...
                'Имя должно содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы':
                    'Имя должно содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы',
                'Фамилия должна содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы':
                    'Фамилия должна содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы',
                'Введите корректный email адрес': 'Введите корректный email адрес',
                'Введите номер телефона в формате: +7 (XXX) XXX-XX-XX или 8 XXX XXX-XX-XX':
                    'Введите номер телефона в формате: +7 (XXX) XXX-XX-XX или 8 XXX XXX-XX-XX',
            ...
            en: {
                ...
                'Я согласен с условиями заказа и политикой конфиденциальности *':
                    'I agree to the order terms and privacy policy *',
                ...
                'Имя должно содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы':
                    'Name must contain 2-50 characters, only letters, spaces, hyphens and apostrophes',
                'Фамилия должна содержать от 2 до 50 символов, только буквы, пробелы, дефисы и апострофы':
                    'Last name must contain 2-50 characters, only letters, spaces, hyphens and apostrophes',
                'Введите корректный email адрес': 'Enter a valid email address',
                'Введите номер телефона в формате: +7 (XXX) XXX-XX-XX или 8 XXX XXX-XX-XX':
                    'Enter phone number in format: +7 (XXX) XXX-XX-XX or 8 XXX XXX-XX-XX',
    ...
    en: {
        ...
        home: {
            ...
            description:
                'Exact reproduction of the legendary 1972 edition with complete text, commentaries by A.C. Bhaktivedanta Swami Prabhupada and 44 original illustrations',
            features: {
        ...
        about: {
            ...
            description:
                'This is an exact reprint of the original 1972 edition, approved by Bhaktivedanta Book Trust. The book represents the complete version with the original text that was shortened in the first edition.',
            ...
            academicQuote:
                'By bringing us a new and living interpretation of a text already known to many, A.C. Bhaktivedanta Swami Prabhupada has increased our understanding manyfold.',
            ...
            authenticityDesc:
                'This edition represents the complete version of the original manuscript that was shortened in the first 1972 edition. Now readers have access to all materials that the author originally planned to include in the book.',
            philosophicalAccuracy: 'Philosophical Accuracy',
            philosophicalDesc:
                "A.C. Bhaktivedanta Swami Prabhupada's commentaries are based on authentic Vedic tradition and transmitted through paramparā (disciple succession). This guarantees the accuracy of philosophical interpretations.",
            historicalValue: 'Historical Value',
            historicalDesc:
                'The 1972 edition became cult for the Western world, presenting Vedic wisdom in an accessible form. This reprint preserves the historical significance of the original edition.',
        ...
        author: {
            ...
            description:
                'Founder of the International Society for Krishna Consciousness (ISKCON) and author of more than 80 books on Vedic philosophy. His translation and commentaries on the Bhagavad-Gita are considered the most authentic and complete, based on paramparā (disciple succession) from Lord Krishna Himself.',
            ...
            childhoodDesc:
                'Abhay Charan De was born on September 1, 1896, in Calcutta, India, to a cloth merchant family. From childhood, he showed deep interest in spirituality and Vedic culture. At the age of 22, he met his spiritual master Śrīla Bhaktisiddhānta Sarasvatī Ṭhākura.',
            meetingGuru: 'Meeting the Spiritual Master',
            meetingGuruDesc:
                'In 1922, Śrīla Bhaktisiddhānta Sarasvatī Ṭhākura gave him the instruction: "If you have money, print books." This became a turning point in Abhay Charan\'s life, determining his future mission to spread Vedic knowledge.',
            renunciation: 'Accepting Renunciation',
            renunciationDesc:
                'In 1959, Abhay Charan accepted renunciation (sannyāsa) and received the name A.C. Bhaktivedanta Swami Prabhupada. From that moment, he completely dedicated himself to writing books and preparing for his mission to the West.',
            foreword: 'Foreword to the 1972 edition',
            missionWest: 'Mission to the West',
            journeyAmerica: 'Journey to America',
            journeyAmericaDesc:
                'In 1965, at the age of 69, Śrīla Prabhupada set out for America on the cargo ship "Jaladuta" with the mission to spread Vedic knowledge in the West. He had only 40 rupees and several copies of his translations.',
            foundingIskcon: 'Founding ISKCON',
            foundingIskconDesc:
                'On July 13, 1966, in New York, Śrīla Prabhupada officially founded the International Society for Krishna Consciousness (ISKCON). This society became the center for spreading Vedic culture and philosophy throughout the world.',
            publishing: 'Publishing Activity',
            publishingDesc:
                'In 1972, Śrīla Prabhupada founded Bhaktivedanta Book Trust (BBT) for publishing and distributing Vedic literature. The first book published by BBT was "Bhagavad-Gita As It Is" from Macmillan Publishing.',
            preface: 'Preface describing the mission',
            literaryHeritage: 'Literary Heritage',
            mainWorks: 'Main Works',
            mainWorksDesc:
                'Over 12 years of active work in the West, Śrīla Prabhupada wrote, translated, and commented on more than 80 books on Vedic philosophy, including:',
            ...
            mainPrinciplesDesc:
                "Śrīla Prabhupada's philosophy is based on the Bhagavad-Gita and other Vedic texts. Key principles include:",
            krishnaConsciousness: 'Krishna Consciousness',
            krishnaConsciousnessDesc:
                'The highest goal of human life is to develop loving relationships with the Supreme Personality of Godhead',
            ...
            westernInfluenceDesc:
                "Thanks to Śrīla Prabhupada's works, Vedic philosophy became accessible to millions of people in the West. His books have been translated into more than 80 languages and are used in universities around the world.",
            legacy: 'Legacy',
            modernInfluence: 'Influence on the Modern World',
            modernInfluenceDesc:
                "Today, ISKCON has more than 600 temples, 100 agricultural communities, and 50 schools worldwide. Śrīla Prabhupada's books continue to inspire people on the spiritual path.",
            academicRecognition: 'Academic Recognition',
            academicRecognitionDesc:
                "Śrīla Prabhupada's works have received recognition from leading scholars and universities, including Harvard, Oxford, and the Sorbonne. His translations are considered the standard in the study of Vedic literature.",
            continuingMission: 'Continuing the Mission',
            continuingMissionDesc:
                "After Śrīla Prabhupada's departure in 1977, his disciples continue his mission to spread Vedic knowledge. Bhaktivedanta Book Trust continues to publish his books in many languages.",
            studyWorks: 'Study the Works of the Great Teacher',
            studyWorksDesc:
                'Immerse yourself in the deep wisdom of the Bhagavad-Gita with commentaries by A.C. Bhaktivedanta Swami Prabhupada'
        },
...
class UniversalTranslator {
    ...
    updatePageTitle() {
        ...
        switch (pageType) {
            ...
            case 'about':
                newTitle =
                    this.currentLang === 'ru' ? 'О книге — Бхагавад-Гита 1972' : 'About the Book — Bhagavad-Gita 1972';
                break;
            case 'author':
                newTitle =
                    this.currentLang === 'ru'
            ...
            case 'thanks':
                newTitle =
                    this.currentLang === 'ru' ? 'Спасибо — Бхагавад-Гита 1972' : 'Thank You — Bhagavad-Gita 1972';
                break;
            default:
                newTitle = this.currentLang === 'ru' ? 'Бхагавад-Гита 1972' : 'Bhagavad-Gita 1972';
        }
    ...
    createTextMap() {
        ...
        map[
            'Это точный репринт оригинального издания 1972 года, одобренный Bhaktivedanta Book Trust. Книга сохраняет:'
        ] = 'about.description';
        ...
        map[
            'А.Ч. Бхактиведанта Свами Прабхупада (1896-1977) - основатель Международного общества сознания Кришны (ISKCON) и автор более 80 книг по ведической философии.'
        ] = 'author.description';
        ...
        map['Ваш заказ принят. Мы свяжемся с вами в ближайшее время для подтверждения деталей доставки.'] =
            'thanks.description';
    ...
    updateContactsPage(main) {
        ...
        if (availability)
            availability.textContent = this.getTranslation('contacts.availability', availability.textContent);
        ...
        if (contactHeader)
            contactHeader.textContent = this.getTranslation('contacts.contactDetails', contactHeader.textContent);
        ...
        if (sectionTitles[0])
            sectionTitles[0].textContent = this.getTranslation('contacts.personalData', sectionTitles[0].textContent);
        if (sectionTitles[1])
            sectionTitles[1].textContent = this.getTranslation(
                'contacts.deliveryAddress',
                sectionTitles[1].textContent
            );
        if (sectionTitles[2])
            sectionTitles[2].textContent = this.getTranslation('contacts.orderDetails', sectionTitles[2].textContent);
        ...
        if (quantitySelect) {
            quantitySelect.querySelectorAll('option').forEach((opt) => {
                if (opt.value === '') {
                    ...
                    if (!isNaN(num)) {
                        const word =
                            this.currentLang === 'ru' ? (num === 1 ? 'книга' : 'книги') : num === 1 ? 'book' : 'books';
        ...
        if (deliveryMethod) {
            deliveryMethod.querySelectorAll('option').forEach((opt) => {
                ...
                if (opt.value === 'post')
                    opt.textContent = this.currentLang === 'ru' ? 'Почта России - 300 ₽' : 'Russian Post - 300 RUB';
                if (opt.value === 'courier')
                    opt.textContent =
                        this.currentLang === 'ru' ? 'Курьерская доставка - 500 ₽' : 'Courier delivery - 500 RUB';
                if (opt.value === 'pickup')
                    opt.textContent = this.currentLang === 'ru' ? 'Самовывоз - 0 ₽' : 'Pickup - 0 RUB';
            });
        }
        ...
        if (orderSummaryHeader)
            orderSummaryHeader.textContent = this.getTranslation(
                'contacts.orderSummary',
                orderSummaryHeader.textContent
            );
    }
    ...
    updateOrderStatusPage(main) {
        ...
        if (input)
            input.setAttribute(
                'placeholder',
                this.currentLang === 'ru' ? 'Введите номер заказа' : 'Enter your order number'
            );
